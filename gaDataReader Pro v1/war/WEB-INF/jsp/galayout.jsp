...
String accessToken=(String)request.getAttribute("accessToken");%>
	...
	<script type="text/javascript" src="https://www.google.com/jsapi"></script>
		...
		var visiteddataarray = new Array();	
			...
			function doPageLoad()
			{
				try{
					...
					var gadata = localStorage.getItem("gadata");//
					gaVisitData = localStorage.getItem("nat");//
					gadata='<%=dataasjson%>';
				...
				$.each(accounts, function(id,acct){
					...
					$('#calldetails_id').append("<tr><td>"+acct.replace("-Acct","")+"</td><td>"+companyname+"</td><td>"+savecount+"</td><td>"+sendcount+"</td><td>"+cccount+"</td><td onclick='viewvisitorsgraph("+replaceAcct+")'>View</td></tr>");
			...
			<div id="dc" class="br9">
				<div class="agent_holder" >
						<table id="calldetails_id">
							<thead>
								<div class="agent_heading" style="height:475;overflow:auto">
